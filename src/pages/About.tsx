      ...
      <div className="max-w-4xl mx-auto text-center relative">
        <div className="animate-fade-in">
          ...
          <img 
            ...
            alt="TimeBack" 
            className="h-[37.8px] inline-block align-middle ml-4"
          />
        </div>
        
        <div className="absolute top-20 left-0 right-0 text-lg animate-fade-in-up delay-200 font-cal" style={{ color: '#0f33bb' }}>
          <p>
